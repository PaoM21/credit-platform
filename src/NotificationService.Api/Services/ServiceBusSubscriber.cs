using System; using System.Text; using System.Threading; using System.Threading.Tasks; using Azure.Messaging.ServiceBus; using Microsoft.Extensions.Hosting; using Microsoft.Extensions.Logging; using Microsoft.Extensions.Configuration; using Microsoft.Extensions.DependencyInjection; using Microsoft.EntityFrameworkCore; using Polly; using CreditService.Infrastructure.Persistence; using CreditService.Infrastructure.Entities; using NotificationService.Api.Handlers;
namespace NotificationService.Api.Services
{
    ...
    public Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        var subscription = _config["ServiceBus:SubscriptionName"] ?? "notification-sub";
        ...
        _log.LogInformation("Starting Notification subscriber {Topic}/{Subscription}", topic, subscription);
    ...
    private async Task ProcessMessageHandler(ProcessMessageEventArgs args)
    {
        ...
        _log.LogInformation("Notification received {MessageId}", messageId);
